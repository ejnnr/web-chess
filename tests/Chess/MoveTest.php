...
class MoveTest extends \PHPUnit_Framework_TestCase
{
    public function testCreateValidMove()
    {
        ...
        $move = new Move(0, 8, PROMOTION_QUEEN, [16, 1]);
        $this->assertInstanceOf('App\Chess\Move', $move);
        $this->assertInstanceOf('App\Chess\Move', new Move([0, 0], [0, 1]));
    ...
    public function testGetDeparture(Move $move)
    {
        ...
        $this->assertSame([0, 0], $move->getDeparture(SQUARE_FORMAT_ARRAY));
    }
    ...
    public function testGetDestination(Move $move)
    {
        ...
        $this->assertSame([0, 1], $move->getDestination(SQUARE_FORMAT_ARRAY));
    }
    ...
    {
        $this->assertSame([1, 16], $move->getNAGs());
    }
}
