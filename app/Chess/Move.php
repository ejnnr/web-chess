...
class Move
{
     ...
     */
    public function __construct($departure, $destination, $promotion = PROMOTION_QUEEN, $NAGs = [], $comment = '')
    {
     ...
     */
    public function getDeparture($format = SQUARE_FORMAT_INT)
    {
        switch ($format) {
     ...
     * @param int $format the format for the square; can be SQUARE_FORMAT_INT, SQUARE_FORMAT_STRING or SQUARE_FORMAT_ARRAY
     */
    public function getDestination($format = SQUARE_FORMAT_INT)
    {
        switch ($format) {
            case SQUARE_FORMAT_INT:
     ...
     *
     * @return int Either 1 (Queen), 2 (Rook), 3 (Bishop) or 4 (Knight); if the move is non-promoting, 1 is returned;
     */
